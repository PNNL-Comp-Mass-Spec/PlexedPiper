...
signifies the confidence of PTM assignment. `AScore > 17` is considered 
confident.
```{r ascore}
...
Fetching and preparing reporter intensities based on MASIC output.
```{r masic}
