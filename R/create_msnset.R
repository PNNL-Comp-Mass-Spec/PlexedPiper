...
#'
#' @param crosstab (matrix) with log2-transformed relative reporter ion
#'   intensities. Row names are the names of the measured species. Column names
#'   are the names of the samples.
#' @param samples (data.table or data.frame) matches sample names to reporter
#'   ions.
#'
#' @return MSnSet object with log2-transformed relative reporter ion
#'   intensities as expression data and the samples table as phenotype data.
#'
