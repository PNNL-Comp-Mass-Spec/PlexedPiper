...
#' @param fractions (data.frame) Info about fractions
#' @param samples (data.frame) Info about the sample experimental design
#' @param references (data.frame) Info about the tmt reference
...
#'
#' out <- create_crosstab(msnid, masic_data, aggregation_level, fractions, 
#'                         samples, references)
#' dim(out)
#' head(out)
#' }
