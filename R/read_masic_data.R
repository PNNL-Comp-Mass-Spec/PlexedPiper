...
#'
#' @param path_to_MASIC_results (character) path to directory with MASIC results
#'   for all datasets.
#' @param interference_score (logical) whether to read interference score.
#'
